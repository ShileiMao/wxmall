...
Page({
    ...
    onLoad: function () {
        ...
        console.log("index page on load called");
    },
    ...
    request({url: '/goodsInfoRecommend/page/all'}).then(res => {
        if(res.code === '0') {
            ...
            if (!goodsInfoRecommendList || goodsInfoRecommendList.length === 0) {
                ...
                /*--allif(goodsInfoRecommendList && goodsInfoRecommendList.length > 4) {
    ...
    request({url: '/goodsInfoHot/page/all'}).then(res => {
        if(res.code === '0') {
            ...
            if (!goodsInfoHotList || goodsInfoHotList.length === 0) {
                ...
                goodsInfoHotList.push({"name": "名称4", "url": this.data.defaultImageUrl});
            } else {
                /*--allif(goodsInfoHotList && goodsInfoHotList.length > 4) {
