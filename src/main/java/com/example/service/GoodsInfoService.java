...
import com.example.dao.GoodsAddressDao;
...
public class GoodsInfoService {
    ...
    public UserAddr findUserAddrByUserId(Long id) {
        List<UserAddr> userAddrs = userAddrDao.getAddress(id);
...
//        }
    ...
    public List<GoodsAddress> findAddressForGoods(Long goodsId) {
        return goodsAddressDao.getAddress(goodsId);
    }
}
